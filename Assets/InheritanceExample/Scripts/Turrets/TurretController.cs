...
public class TurretController : MonoBehaviour
{
    ...
    [SerializeField] private GameObject _aimIndicator;
        ...
        // Method to reduce shot cooldown
        public void ReduceShotCooldown(float reductionFactor)
        {
            FireCooldown *= reductionFactor;
        }

        // Method to reset shot cooldown to original duration
        public void ResetShotCooldown()
        {
            FireCooldown = 0.5f; // Set it back to the original duration or your default value
        }
